...
import { buildVectorPdfTestDocument, getPdfMathVectorSize, isSafePdfMathSvg, latexToPdfText, measurePdfMath, shouldRenderStandaloneFormula, splitPdfMathSegments } from "../client/src/lib/questionPdfGenerator";
...
describe("exportação de questões em PDF", () => {
  ...
  it("mantém a marca d'água vetorial em todas as páginas", async () => {
    ...
    expect(source.match(/\(PROJETO\) Tj/g)).toHaveLength(2);
  });
