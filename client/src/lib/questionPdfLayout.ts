...
export const QUESTION_PDF_LAYOUT = {
  // 50% larger than the original compact export while retaining aspect ratio.
  statementImageMaxWidth: 708,
  statementImageMaxHeight: 427.5,
  optionImageMaxWidth: 531,
  optionImageMaxHeight: 330,
  resolutionSpaceHeight: 168,
} as const;
