          ...
          <Card className="p-6">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500">{weights.length} ajuste(s)</p>
                <p className="mt-1 text-xs text-slate-500">Atualização coletiva manual • {statsStatus?.groups ?? 0} grupo(s) • última atualização: {statsStatus?.lastUpdatedAt ? new Date(statsStatus.lastUpdatedAt).toLocaleString("pt-BR") : "ainda não executada"}</p>
