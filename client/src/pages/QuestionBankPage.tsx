...
import { formatDifficultyLabel, getDifficultyColor, getDifficultyOrder, normalizeDifficulty } from "@/lib/difficulty";
import {
  ArrowLeft,
  Zap,
  BarChart3,
                ...
                <div className="space-y-3">
                  {difficultyStats.length > 0 ? (
                    difficultyStats.map((item) => {
                      ...
                      const colorClass = getDifficultyColor(item.key);
