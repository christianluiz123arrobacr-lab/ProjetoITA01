                ...
                <div className="absolute right-0 mt-3 w-64 rounded-xl border border-slate-200 bg-white p-3 shadow-lg z-50 dark:border-slate-700 dark:bg-slate-900">
                  ...
                  <div className="py-2 space-y-1">
                    ...
                    <Link href="/indique-e-ganhe">
                      <button type="button" onClick={() => setProfileMenuOpen(false)} className="flex w-full items-center gap-3 rounded-2xl border border-transparent px-3 py-3 text-left text-sm font-semibold text-slate-700 transition duration-150 hover:border-cyan-100 hover:bg-cyan-50/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 dark:text-slate-200 dark:hover:border-cyan-900 dark:hover:bg-slate-800">
